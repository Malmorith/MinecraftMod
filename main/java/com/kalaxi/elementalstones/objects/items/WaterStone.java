...
public class WaterStone extends Item
{
	...
	public ActionResultType onItemUse(ItemUseContext context) 
	{
		...
		BlockState bs = BlockInit.potential_block_water.getBlock().getDefaultState();
		ItemStack itemstack = context.getItem();
			...
			if(!worldIn.isRemote) {
				...
				if(worldIn.getBlockState(pos).getBlock()==BlockInit.potential_block_water) {
					player.addPotionEffect(new EffectInstance(Effects.WATER_BREATHING, 12000));
